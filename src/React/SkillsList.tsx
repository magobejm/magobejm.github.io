...
const SkillsList = () => {
  ...
  const skills = {
    "Enterprise Development": [
      "Business web applications and internal platforms",
      "Transaction-oriented and process-driven systems",
      "Maintenance and evolution of legacy applications",
    ],
    "Analysis & Architecture": [
      "Functional and technical analysis",
      "Application architecture design",
      "Technical advisory for implementation teams",
    ],
    "Delivery & Leadership": [
      "Project and team coordination",
      "Cross-team collaboration in enterprise environments",
      "Quality-focused delivery and continuous improvement",
    ],
  };
